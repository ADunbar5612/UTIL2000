      ...
      ***************************************************************** 00030000
      *  Programmer.: AIDAN DUNBAR                                      00040000
      *  Date.......: 02/10/2026                                        00050001
      *  GitHub URL.:                                                   00060000
      ...
      ***************************************************************** 00230000
       ...
       01  WS-CUST2.                                                    00281001
           ...
           05  WS-C2-FEE            PIC 9(3)V99 VALUE 14.95.            00284001
                                                                        00285001
       01  WS-CUST3.                                                    00286001
           05  WS-C3-NAME           PIC X(12)   VALUE 'CUST-ALPHA  '.   00287001
      ...
      ***************************************************************** 00640000
       000-MAIN.                                                        00650000
           DISPLAY '********************************'.                  00660000
           DISPLAY '*** UTIL1000 - CUSTOMER BILL ***'.                  00670000
           DISPLAY '********************************'.                  00680000
           DISPLAY ' '.                                                 00690000
                                                                        00700000
           PERFORM 500-LOAD-CUST.                                       00710000
           PERFORM 600-RUN-BILL.                                        00720000
                                                                        00730000
           STOP RUN.                                                    00740000
                                                                        00750000
      ***************************************************************** 00760000
      ...
      ***************************************************************** 00780000
       500-LOAD-CUST.                                                   00790000
           MOVE WS-C1-NAME TO WS-CUST-NAME.                             00800000
           MOVE WS-C1-KWH  TO WS-KWH-USED.                              00810000
           MOVE WS-C1-FEE  TO WS-SERVICE-FEE.                           00820000
                                                                        00830000
      ***************************************************************** 00840000
      ...
      * - Tier 2: next 500 kWh (kWh 501 10000 at $0.15/kWh              01130000
       ...
       300-CALC-CHARGES.                                                01430000
           COMPUTE WS-TIER1-CHARGE ROUNDED =                            01440000
               WS-TIER1-KWH * WS-RATE-TIER1.                            01450000
                                                                        01460000
           COMPUTE WS-SUBTOTAL = WS-TIER1-CHARGE.                       01470000
           COMPUTE WS-TIER2-CHARGE ROUNDED =                            01470101
               WS-TIER2-KWH * WS-RATE-TIER2.                            01470201
                                                                        01470301
           COMPUTE WS-SUBTOTAL = WS-SUBTOTAL + WS-TIER2-CHARGE.         01470401
           COMPUTE WS-TIER3-CHARGE ROUNDED =                            01471001
               WS-TIER3-KWH * WS-RATE-TIER3.                            01472001
                                                                        01473001
           COMPUTE WS-SUBTOTAL = WS-SUBTOTAL + WS-TIER3-CHARGE.         01474001
                                                                        01480000
